...
//    https://stackoverflow.com/questions/8605611/get-context-of-test-project-in-android-junit-test-case
    ...
    @Test
    public void testDirectionsReplanRejected() throws UiObjectNotFoundException {
//    https://stackoverflow.com/questions/8605611/get-context-of-test-project-in-android-junit-test-case
        Context context = ApplicationProvider.getApplicationContext();
        ...
        UiObject replanButton = uiDevice.findObject(new UiSelector().text(String.valueOf(android.R.string.no)));
        if (replanButton.exists() && replanButton.isEnabled()) {
            replanButton.click();
        }
